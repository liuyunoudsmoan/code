...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--name', type=str, default='results',
        ...
        g_test.add_argument('--test_folder_path', type=str, default='img/', help='the folder of test image')
        # Sampling related
        ...
        parser.add_argument('--load_netG_checkpoint_path', type=str, default='script/checkpoints/example/netG_epoch_1', help='path to save checkpoints')
        parser.add_argument('--load_netC_checkpoint_path', type=str, default='script/checkpoints/example/netC_epoch_2', help='path to save checkpoints')
